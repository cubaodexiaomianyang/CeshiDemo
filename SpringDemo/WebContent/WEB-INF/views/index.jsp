...
<body>
				...
				<ul class="nav ace-nav">
					...
					<li class="green"><a data-toggle="dropdown"
						...
						<ul
							...
							<li><a href="#"> <img src="${jpath}/static/assets/avatars/avatar.png"
							...
							<li><a href="#"> <img src="${jpath}/static/assets/avatars/avatar3.png"
							...
							<li><a href="#"> <img src="${jpath}/static/assets/avatars/avatar4.png"
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <img class="nav-user-photo"
							src="${jpath}/static/assets/avatars/user.jpg" alt="Jason's Photo" /> <span
						...
						<ul
							...
							<li><a href="${jpath}/LoginController/tuichu"> <i class="icon-off"></i> 退出
							</a></li>
						</ul></li>
				</ul>
				<!-- /.ace-nav -->
		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					<li class="active"><a href="${jpath}/content" onClick="dianji(this);return false;"> <i
							class="icon-dashboard"></i> <span class="menu-text">控制台 </span>
					</a></li>

					<li><a href="${jpath}/UserTypeController/chaxun" onClick="dianji(this);return false;"> <i
							class="icon-dashboard"></i> <span class="menu-text">添加用户</span>
					</a></li>
						<li class="open">
							...
							<ul class="submenu">
									<li class="open"><a href="${jpath}/biaoge" onClick="dianji(this);return false;"> <i
									class="icon-dashboard"></i> <span class="menu-text">用户行业表</span>
									</a></li>
									
									<li class="open"><a href="${jpath}/userbiaoge" onClick="dianji(this);return false;"> <i
									class="icon-dashboard"></i> <span class="menu-text">用户信息表</span>
									</a></li>
							</ul>
						</li>
						<li class="open">
							...
							<ul class="submenu">
									<li class="open"><a href="${jpath}/XinWenLanMuBiaoController/tiaozhuan" onClick="dianji(this);return false;"> <i
									class="icon-dashboard"></i> <span class="menu-text">新闻栏目</span>
									</a></li>
									
									<li class="open"><a href="${jpath}/XinWenzixunController/tiaozhuan" onClick="dianji(this);return false;"> <i
									class="icon-dashboard"></i> <span class="menu-text">新闻咨询</span>
									</a></li>
							</ul>
						</li>
						
						<li><a href="${jpath}/CpController/tiaozhuan" onClick="dianji(this);return false;"> <i
							class="icon-dashboard"></i> <span class="menu-text">产品表格</span>
					</a></li>
			...
			<div class="main-content">
				...
				<div class="page-content">
					<iframe height="600px" id="contentpage" width="100%" frameborder="0" src="${jpath}/content">
	...
	<script type="text/javascript">
		...
		function dianji(_this){
			...
			var zhi=$(_this).attr("href");
			$("#contentpage").attr("src",zhi);
